...
$config = array(
    ...
    "key"              => "i2L5b8HK9XBkIXdf0oHrTHm5KqVlJiTX", //Enter your consumer key here
    "secret"           => "uWXXWtZUWFnsUVLG", //Enter your consumer secret here
    "username"         => "apitest",
    ...
    "AccountReference" => "WARIDI ESTATE",
    "TransactionDesc"  => "Payment for October Service Charge" ,
);
...
if (isset($_POST['phone_number'])) {
    ...
    if($result['ResponseCode'] === "0"){    //STK Push request successfull
        $MerchantRequestID = $result['MerchantRequestID'];
        $CheckoutRequestID = $result['CheckoutRequestID'];

        // Saves your request to a database
        $conn = mysqli_connect("localhost:3307", "root", "", "mpesa");
