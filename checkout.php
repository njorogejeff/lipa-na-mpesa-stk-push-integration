...
<html>
  <head>
    <style>
      @import url('https://fonts.googleapis.com/css2?family=Lato:wght@100;300;400;700;900&family=Source+Code+Pro:wght@200;300;400;500;600;700;900&display=swap');
      .container {
        display: flex;
        align-items: center;
  ...
  <body>
    <div class="container">
      <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
        <div class="price">
          <!-- For testing purposes, we have added the amount manually. This should proceed from your website -->
          <h1>Awesome, that's KES 100</h1>
        </div>
        <div class="card__container">
          <div class="card">
            <div class="row">
              <img src="mpesa.png" style="width:30%;margin:0 35%;" alt="">
            ...
            <div class="row number">
              <div class="info">
                ...
                <input type="text" id="cardnumber" name="phone_number" maxlength="10" placeholder="0700000000" />
              </div>
            </div>
          </div>
        </div>
      ...
      <p style="color:#8F92C3;line-height:1.7;margin-top:5rem;">Copyright 2023 | All Rights Reserved</p>
    </div>
  </body>
</html>