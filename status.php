...
/* Call function with these configurations */
    ...
    $type = 4;
    $shortcode = '600988';
    $key = "i2L5b8HK9XBkIXdf0oHrTHm5KqVlJiTX";  // Put your key here
    $secret = "uWXXWtZUWFnsUVLG";   // Put your secret here
    ...
    $timeout_url = "https://mydomain.com/TransactionStatus/queue/";     // Endpoint to go to on timeout
/* End configurations */
